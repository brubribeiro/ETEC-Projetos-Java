...
public class FrmCadastroLogin extends javax.swing.JFrame
{
        ...
        if (loginFicha.size() > 0)
          {
            ...
            if (n == 0)
              ...
              {
                cmbNivel.setSelectedIndex(2);
              }
            else if (n == 2)
              {
                cmbNivel.setSelectedIndex(3);
              }
            ...
            if (a == true)
              {
                cmbAtivo.setSelectedIndex(1);
              }
            else
              {

                cmbAtivo.setSelectedIndex(2);
              }
        ...
        try
          {
            ...
            dadosLogin.setSenha(geraHash(txtSenha.getText()));
            ...
            String a = String.valueOf(cmbAtivo.getSelectedItem());
    ...
    private void cancelar()
      {
        ...
        cmbAtivo.setEditable(false);
        cmbNivel.setEditable(false);
        cmbCodFun.setEditable(false);

        cmbAtivo.setPopupVisible(false);
        cmbCodFun.setPopupVisible(false);
        cmbNivel.setPopupVisible(false);
      }
    ...
    private void initComponents()
    {
        ...
        cmbNivel.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "Administrador", "Usuário", "Convidado" }));

        cmbAtivo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "Ativo", "Bloqueado" }));
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(cmbNivel, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(cmbAtivo, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGroup(layout.createSequentialGroup()
    ...
    private javax.swing.JComboBox cmbAtivo;
