...
public class FrmCadastroLoginSimples extends javax.swing.JFrame
{
    ...
    public FrmCadastroLoginSimples()
      {
        initComponents();
        cancelar();
        primeraPosicao();
...
//            txtNivel.setText(String.valueOf(loginFicha.get(pos).getNivel()));
//            txtAtivo.setText(String.valueOf(loginFicha.get(pos).isAtivo()));

            int n = ((loginFicha.get(pos).getNivel()));
            if (n == 0)
              {
                txtNivel.setText("Adminstrador");
              }
            else if (n == 1)
              {
                txtNivel.setText("Usuário");
              }
            else if (n == 3)
              {
                txtNivel.setText("Convidado");
              }

            System.out.println(pos + " " + loginFicha.get(pos).getUsuario() + "  " + String.valueOf(loginFicha.get(pos).isAtivo()));
            boolean a = (loginFicha.get(pos).isAtivo());

            if (a == true)
              {
                txtAtivo.setText("Usuário Ativo");
              }
            else
              {
                txtAtivo.setText("Usuário Bloqueado");
              }

            txtCodigoFuncionario.setText(String.valueOf(loginFicha.get(pos).getCodFuncionario()));
    ...
    public void limpar()
      {
        ...
        txtCodigoFuncionario.setText(null);
        ...
        try
          {
            ...
            if (txtNivel.getText().equals("Adminstrador"))
              {
              dadosLogin.setNivel(0);
              }
            else if (txtNivel.getText().equals("Usuário"))
              {
               dadosLogin.setNivel(1);
              }
            else if (txtNivel.getText().equals("Convidado"))
              {
               dadosLogin.setNivel(2);
              }
           
            if (txtAtivo.getText().equals("Usuário Ativo"))
              {
            ...
            dadosLogin.setCodFuncionario(Integer.parseInt(txtCodigoFuncionario.getText()));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        .addComponent(txtAtivo, javax.swing.GroupLayout.PREFERRED_SIZE, 171, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(txtCodigoFuncionario, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE)))))
    ...
    {//GEN-HEADEREND:event_btnNovoActionPerformed
        ...
        txtAtivo.setEditable(true);
        txtCodigoFuncionario.setEditable(true);
