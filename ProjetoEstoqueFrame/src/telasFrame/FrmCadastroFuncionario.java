...
public class FrmCadastroFuncionario extends javax.swing.JFrame
{
    ...
    public void carregaPosicao(int pos)
      {
        funcionarioFicha.clear();
        acessaBDFuncionario.consultaBD(dadosFuncionario, 2);
        if (acessaBDFuncionario.listaDados.isEmpty())
          {
    ...
    public final void carregarDados(int pos)
      {
        ...
        if (funcionarioFicha.size() > 0)
          {
            codigo = funcionarioFicha.get(pos).getCodigo();
            txtNome.setText(funcionarioFicha.get(pos).getNome());
            txtCargo.setText(funcionarioFicha.get(pos).getCargo());
            txtTelefone.setText(String.valueOf(funcionarioFicha.get(pos).getTelefone()));
            btnCadastrar.setEnabled(false);

            dadosFuncionario.setCodigo(codigo);
            dadosFuncionario.setNome(txtNome.getText());
            dadosFuncionario.setCargo(txtCargo.getText());
    ...
    public void alterar()
      {
        ...
        if (acessaBDFuncionario.alterarFuncionario(dadosFuncionario) > 0)
          {
    ...
    public void cadastrar()
      {
        ...
        if (acessaBDFuncionario.cadastraFuncionario(dadosFuncionario) > 0)
          {
    ...
    public void proximaPosicao()
      {
        ...
        int ultimo = funcionarioFicha.size();
    ...
    public void ultimaPosicao()
      {
        ...
        posNavegacao = acessaBDFuncionario.listaDados.size();
            ...
            if (escolha == 0)
              {
                ...
                acessaBDFuncionario.excluirFuncionario(dadosFuncionario);
